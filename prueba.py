...
Original file is located at
    https://colab.research.google.com/drive/1eG07DwrE_K_SSLWsAumZgkaECKyJx2qz
"""
...
if archivo is not None:
    ...
    # Bloque 1: Gráfica individual por abscisa seleccionada
    st.subheader("📍 Evolución de la profundidad por abscisa (individual)")

    # Convertir nombres de fechas
