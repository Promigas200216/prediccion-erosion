...
# Solo si se procesaron todas, mostramos resumen global
if df_y is not None and df_x is not None and df_a is not None:
    try:
        ...
        st.markdown("Cantidad de variables donde cada abscisa se encuentra bajo su respectivo umbral.")
        st.dataframe(df_global[["Abscisa", "Indicador Global (0-3)"]])
    except Exception as e:
